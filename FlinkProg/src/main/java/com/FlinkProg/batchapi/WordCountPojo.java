...
/*text.flatMap((value, out) -> {String[] tokens = value.toLowerCase().split("\\W+");
	// emit the pairs
...
text.flatMap(new FlatMapFunction<String, Word>() {
...
//reduce((value1, value2) -> { return new Word(value1.word, value1.frequency + value2.frequency); });
